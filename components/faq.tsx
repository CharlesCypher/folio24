  ...
  return (
    <section className="px-6 py-16">
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1" className="bg-foreground border-none rounded-lg mb-6">
        ...
        <AccordionItem value="item-2" className="bg-foreground border-none rounded-lg mb-6">
          <AccordionTrigger className="text-card py-0 p-9">How easy?</AccordionTrigger>
          <AccordionContent className="text-popover text-base pb-8 px-9">Yes. It adheres to the WAI-ARIA design pattern.</AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-3" className="bg-foreground border-none rounded-lg mb-6">
          <AccordionTrigger className="text-card py-0 p-9">Who&apos;s behind?</AccordionTrigger>
          <AccordionContent className="text-popover text-base pb-8 px-9">Yes. It adheres to the WAI-ARIA design pattern.</AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-4" className="bg-foreground border-none rounded-lg">
