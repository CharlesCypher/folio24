...
export default function Hero() {
  return (
    <main>
      <section>
        <h1 className="text-[2.5rem] md:text-5xl md:w-4/5 lg:text-[4rem] lg:w-full xl:w-3/5 text-foreground leading-[1.18em] lg:leading-[1.2em] font-semibold mb-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-4">
          ...
          <div className="w-full h-[0.5px] bg-background"></div>
          <div className="">
